...
```{r}
# STOCK PRICES
sp_500_prices_tbl <- read_rds("C:/Users/ANISH SUNDAR/OneDrive/Documents/GitHub/bdml-anishsundargowthaman/data/Business Decisions with Machine Learning/sp_500_prices_tbl.rds")
sp_500_prices_tbl
```
...
```{r}
# SECTOR INFORMATION
sp_500_index_tbl <- read_rds("C:/Users/ANISH SUNDAR/OneDrive/Documents/GitHub/bdml-anishsundargowthaman/data/Business Decisions with Machine Learning/sp_500_index_tbl.rds")
sp_500_index_tbl
```
...
```{r}
sp_500_daily_returns_tbl <- read_rds("C:/Users/ANISH SUNDAR/OneDrive/Documents/GitHub/bdml-anishsundargowthaman/data/Business Decisions with Machine Learning/sp_500_daily_returns_tbl.rds")
sp_500_daily_returns_tbl
```
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
stock_date_matrix_tbl <- read_rds("C:/Users/ANISH SUNDAR/OneDrive/Documents/GitHub/bdml-anishsundargowthaman/data/Business Decisions with Machine Learning/stock_date_matrix_tbl.rds")
stock_date_matrix_tbl
```
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
k_means_mapped_tbl <- read_rds("C:/Users/ANISH SUNDAR/OneDrive/Documents/GitHub/bdml-anishsundargowthaman/data/Business Decisions with Machine Learning/k_means_mapped_tbl.rds")
k_means_mapped_tbl
```
...
```{r}
k_means_mapped_tbl <- read_rds("C:/Users/ANISH SUNDAR/OneDrive/Documents/GitHub/bdml-anishsundargowthaman/data/Business Decisions with Machine Learning/k_means_mapped_tbl.rds")
umap_results_tbl   <- read_rds("C:/Users/ANISH SUNDAR/OneDrive/Documents/GitHub/bdml-anishsundargowthaman/data/Business Decisions with Machine Learning/umap_results_tbl.rds")
umap_results_tbl 
k_means_mapped_tbl 
```
