...
\hypersetup{
  ...
  pdfauthor={Rishon Noel Saldanha},
  hidelinks,
...
\includegraphics{01_ml_fund_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\NormalTok{umap\_results\_tbl }\OtherTok{\textless{}{-}}\NormalTok{ umap\_results}\SpecialCharTok{$}\NormalTok{layout }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{as\_tibble}\NormalTok{(}\AttributeTok{.name\_repair =} \StringTok{"unique"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# argument is required to set names in the next step}
...
\NormalTok{        stock\_date\_matrix\_tbl }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(symbol)}
\NormalTok{    )}
...
\includegraphics{01_ml_fund_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\includegraphics{01_ml_fund_files/figure-latex/unnamed-chunk-21-1.pdf}
